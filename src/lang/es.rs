...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("TPV mode", "Modo TPV (acceso desatendido silencioso)"),
        ("tpv_mode_tip", "Para TPV y equipos desatendidos: las conexiones que traigan la contraseña permanente se aceptan solas, sin ninguna ventana, aviso ni notificación en este equipo. Solo puede conectarse quien conozca la contraseña."),
        ("tpv_mode_active", "Modo TPV activo: este equipo acepta conexiones en silencio con la contraseña permanente."),
        ("tpv_mode_inactive", "Modo TPV desactivado: cada conexión entrante muestra la ventana de aceptar."),
        ("Enable TPV mode", "Activar modo TPV"),
        ("Disable TPV mode", "Desactivar modo TPV"),
    ].iter().cloned().collect();
}
